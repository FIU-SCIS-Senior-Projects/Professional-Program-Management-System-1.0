...
var sessionService = (function () {
    function sessionService(_http) {
        this._http = _http;
        this._sessionUrl = 'api/sessions/sessions.json';
    }
    sessionService.prototype.getsessions = function () {
        return this._http.get(this._sessionUrl)
    ...
    sessionService.prototype.getsession = function (id) {
        return this.getsessions()
            .map(function (sessions) { return sessions.find(function (p) { return p.sessionId === id; }); });
    };
